...
struct TestCcdbConsumer0 {
  ...
  void init(o2::framework::InitContext&)
  {
    ...
    auto hBookkeeping = histos.add<TH1>("hBookkeeping", "hBookkeeping", o2::framework::kTH1D, {{3, 0.5f, 3.5f}});
    hBookkeeping->GetXaxis()->SetBinLabel(1, "Smearing Success");
    hBookkeeping->GetXaxis()->SetBinLabel(2, "Smearing Failed");
    hBookkeeping->GetXaxis()->SetBinLabel(3, "Smearing NaN");
  ...
  void process(o2::aod::McCollisions::iterator const&, o2::aod::McParticles const& mcParticles, o2::aod::A3LookUpTables const& luts)
  {
    ...
    for (const auto& mcParticle : mcParticles) {
      ...
      if (std::isnan(trackParCov.getZ())) {
        histos.fill(HIST("hBookkeeping"), 3.0f);
        continue;
      }
      ...
      switch (std::abs(mcParticle.pdgCode())) {
        ...
        case PDG_t::kMuonMinus:
          ...
          break;
        case PDG_t::kPiPlus:
          LOG(info) << "trackParCov pT: " << trackParCov.getPt();
          LOG(info) << "mcParticle pT.: " << mcParticle.pt() << std::endl;
